...
public class BufferedStreamTest {
    public static void main(String[] args) {
        try(FileReader fis = new FileReader("src/exercise/chapter_56/test_long.txt");
            FileWriter fws = new FileWriter("src/exercise/chapter_56/ouput_long.txt")
        ){
        ...
        try(BufferedReader bfr = new BufferedReader(new FileReader("src/exercise/chapter_56/test_long.txt"));
            BufferedWriter bfw = new BufferedWriter(new FileWriter("src/exercise/chapter_56/ouput_long.txt"))
        ){
            long start = System.currentTimeMillis();
            int data;
