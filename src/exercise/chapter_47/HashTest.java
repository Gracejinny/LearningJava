...
public class HashTest {
    ...
    public static void main(String[] args) {
        ...
        long hashCode3 = Objects.hashCode(new Customer("미철"));
        ...
        System.out.println("Objects HashCode : " + hashCode3);
        System.out.println("Objects HashCode : " + hashCode4);

        Customer customer1 = new Customer("ID1", "미철");
        Customer customer2 = new Customer("ID2", "미철");
        ...
        System.out.println("첫번째 Customer2 : " + hashCodeCustomer2);
