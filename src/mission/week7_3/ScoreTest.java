...
public class ScoreTest {
    public static void main(String[] args){
        ...
        double averageScoreTop3 = femaleStudentsCount < 3 ? 0 : students.stream().filter(student -> student.getGender().equals("여자"))
                        .sorted((s1,s2)-> s2.getScore() - s1.getScore()).limit(3)
